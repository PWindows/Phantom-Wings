...
debug:
	go build -ldflags="-X github.com/pwindows/phantom-wings/system.Version=$(GIT_HEAD)"
...
rmdebug:
	go build -gcflags "all=-N -l" -ldflags="-X github.com/pwindows/phantom-wings/system.Version=$(GIT_HEAD)" -race
